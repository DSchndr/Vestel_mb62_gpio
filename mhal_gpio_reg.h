...
//
// Lol, you don't get documentation nor sources from mstar and reverse engineering is legal (like in this case where we want to add functionality) in eu, so who cares.
//
////////////////////////////////////////////////////////////////////////////////

extern unsigned int MHal_GPIO_REG(unsigned int addr);
extern unsigned int MHal_Get_Reg_Address(unsigned int addr);
...
//bf.. is legal in kernel space since it is somehow mapped? causes cpu hang since we access invalid memory
#define REG_MIPS_BASE               0x1f000000 //0xBF000000//Use 8 bit addressing
...
#define GPIO_OEN    0   //set 0 for output
#define GPIO_ODN    1
